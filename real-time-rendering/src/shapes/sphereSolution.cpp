#include "sphereSolution.h"
#include "glm/gtc/constants.hpp"
/*********************** from lab10. for testing sphere *****************************/

glm::vec4 SphereSolution::sphericalToCartesian(float phi, float theta)
{
...
void SphereSolution::pushVec3(glm::vec4 vec, std::vector<float>* data)
{
...
std::vector<float> SphereSolution::generateSphereData(int phiTesselations, int thetaTesselations)
{
