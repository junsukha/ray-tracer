...
namespace Reflection {
	...
	using ContainerReplaceElementType = typename Private::ContainerReplaceTypeArgument<std::decay_t<ReferenceContainerType>, TargetElementTypes...>::ReassembledType;

	template<typename UnknownType>
	using ExtractInnermostElementType = typename Private::ExtractInnermostTypeArgument<std::remove_cvref_t<UnknownType>>::IrreducibleType;
}
